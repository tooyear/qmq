 ...
 */
public class JdbcDicStore implements DicStore {
    ...
    public JdbcDicStore(String table) {
        jdbcTemplate = JdbcTemplateHolder.getOrCreate();
    ...
    public int getId(String name) {
        return jdbcTemplate.queryForObject(getIdSql, Integer.class, new Object[]{name});
    }
